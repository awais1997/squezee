            ...
            if (value.type === ControlType.String && key === 'children') {
              ...
              return (
                <div key={key}>
                  ...
                  <Input
                    sx={{ backgroundColor: 'white' }}
                    value={fieldValue}
                    onChange={(e: any) => onPropChange(key, e)}
                    id={title}
                  />
                </div>
              );
              ...
              return (
                <div key={key}>
                  ...
                  <Input
                    ...
                    type="number"
                    value={fieldValue}
                    onChange={(e: any) => onPropChange(key, e, ControlType.Number)}
                    id={title}
                  />
                </div>
              );
              ...
              return (
                <Field
                  ...
                  as={Select}
                >
                  {value.options.map((option: any) => <option key={option}>{option}</option>)}
                </Field>
              );
                  ...
                  >
                    <Label sx={{ alignItems: 'center' }}>
                      <Radio
                        ...
                        onChange={(e: any) => onPropChange(key, e, ControlType.Boolean)
                        }
                      />{' '}
