...
export const toTransformedJSX = (code: any) => {
  try {
...
export const toTransformedBlockJSX = (code: any) => {
...
export const toRawJSX = (code: any) => {
